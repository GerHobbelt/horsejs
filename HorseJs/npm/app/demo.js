(() => {
  ...
  var demo = {
    init: () => {
      ...
      $("#openDevToolBtn").addEventListener("click", () => __async(void 0, null, function* () {
        yield horse.window.openDevTool();
      }));
      $("#openDocument").addEventListener("click", () => __async(void 0, null, function* () {
      ...
      $("#demoContainer").addEventListener("click", (e) => __async(void 0, null, function* () {
        ...
        let { processor } = yield import(`./demo/${parentId}.js`);
        processor[id]();
      }));
    }
  };
